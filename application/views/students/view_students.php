	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="pull-right">
				<a href="<?php echo base_url('students/new_student');?>" class="btn btn-danger">New Student</a>
			</div>
			<div class="pull-right">
				<a href="<?php echo base_url('students/new_student');?>" class="btn btn-danger">New Course</a>
			</div>
